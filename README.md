...
| [![Compact Foam Camper](projects/foam-camper/foam-camper.png)](projects/foam-camper/) | ### 4. [Compact Foam Camper](projects/foam-camper/README.md)<br>**Ultralight 12' x 6.5' Towable Rigid Foam Camper Shell (3D Form Studies)**<br><br>• **Application**: Ultralight towable micro-camper shell exploration for scored and bent Extruded Polystyrene (XPS) rigid foam insulation.<br>• **Core Architecture**: Parametric FreeCAD 1.1 `App::VarSet` engine (`Vars`) sized for a 12'-0" × 6'-6" trailer bed; 3 comparative solid form modeling studies (Form A: Orthogonal sketch pad & pocket intersection; Form B: Ruled developable multi-chine hull modeling 12°–35° kerf-score folds; Form C: 4-station transverse spline loft teardrop shell); reference trailer chassis with 60/40 axle line; comprehensive volume and mass engineering analysis (~125–145 lbs foam shell).<br>• **Active Master**: [**v0.1.0**](projects/foam-camper/) 🟢 **`[CURRENT / ACTIVE]`**<br>• 📖 [**`README.md`**](projects/foam-camper/README.md) \| 📋 [**`ASSEMBLY.md`**](projects/foam-camper/ASSEMBLY.md) \| 🔨 [**`fabrication/`**](projects/foam-camper/fabrication/README.md) \| 📐 [**`SPECIFICATION.md`**](projects/foam-camper/SPECIFICATION.md) \| 📜 [**`CHANGELOG.md`**](projects/foam-camper/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](projects/foam-camper/build.py) \| 📦 [**`foam-camper.FCStd`**](projects/foam-camper/foam-camper.FCStd) |
