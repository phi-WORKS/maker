...
| [![Compact Foam Camper](projects/foam-camper/foam-camper.png)](projects/foam-camper/) | ### 4. [Compact Foam Camper](projects/foam-camper/README.md)<br>**Ultralight 12' x 6.5' Pop-Top Rigid Foam Camper (Orthogonal 1D Developable Curved Intersection)**<br><br>• **Application**: Ultralight towable micro-camper shell engineered for single-axis 1D scored and curved Extruded Polystyrene (XPS) rigid foam.<br>• **Core Architecture**: Parametric FreeCAD 1.1 `App::VarSet` engine (`Vars`) sized for a 12'-0" × 6'-6" trailer bed; orthogonal intersection of two single-axis developable curved planes ($XY$ boat-tail plan curve with vertical rulings and $XZ$ aerodynamic elevation curve with lateral rulings) forming a compound 3D shoulder seam without compound panel bending; modular partition into Left/Port and Right/Starboard side frames, central 20" ($508\text{ mm}$) pop-up roof frame with weather-resistant canvas bellows, front towing-end bulkhead with 24" center walk-through door, and rear transom; 6'0" standing human mannequin reference ($\ge 6'5.5''$ / $1,968\text{ mm}$ standing headroom in camping mode); reference trailer chassis with tongue A-frame walk platform.<br>• **Active Master**: [**v0.2.0**](projects/foam-camper/) 🟢 **`[CURRENT / ACTIVE]`**<br>• 📖 [**`README.md`**](projects/foam-camper/README.md) \| 📋 [**`ASSEMBLY.md`**](projects/foam-camper/ASSEMBLY.md) \| 🔨 [**`fabrication/`**](projects/foam-camper/fabrication/README.md) \| 📐 [**`SPECIFICATION.md`**](projects/foam-camper/SPECIFICATION.md) \| 📜 [**`CHANGELOG.md`**](projects/foam-camper/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](projects/foam-camper/build.py) \| 📦 [**`foam-camper.FCStd`**](projects/foam-camper/foam-camper.FCStd) |
