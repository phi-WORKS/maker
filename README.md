...
| :---: | :--- |
| [![Road Roaster 4W Render](projects/road-roaster-4w/road-roaster-4w.png)](projects/road-roaster-4w/) | • **Application**: Heavy-duty commercial 24" × 36" platform cart for large-scale driveway & headland weed shock.<br>• **Core Advantage**: Solaronics K-30 30,000 BTU ceramic infrared engine; 3-sided wrap-around rigid skirt with continuous 3/4" pivot axle; front cantilevered burner with 180° flip-back transit stowage; carries full 20 lb propane cylinder (~14.4 hrs runtime) & 2.5 gal water safety tank; auxiliary torch wand on handle; crawl propulsion ready.<br>• **Active Master**: [**v0.2.0**](projects/road-roaster-4w/) 🟢 **`[RELEASED]`**<br>• 📖 [**README.md**](projects/road-roaster-4w/README.md)<br>• 📐 [**SPECIFICATION.md**](projects/road-roaster-4w/SPECIFICATION.md)<br>• 📜 [**CHANGELOG.md**](projects/road-roaster-4w/CHANGELOG.md)<br>• 🛠️ [**build.py**](projects/road-roaster-4w/build.py)<br>• 📦 [**road-roaster-4w.FCStd**](projects/road-roaster-4w/road-roaster-4w.FCStd) |
