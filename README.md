...
| **🌲 Master Projects (`projects/`)** | Integrated Physical Systems | Complete fabricated products (Road Roaster 4W, Road Roaster, Kombi Kaddy, Compact Foam Camper) maintaining single active master files (`build.py`, `<model>.FCStd`, `<model>.png`, `SPECIFICATION.md`, `CHANGELOG.md`, `BOM.md`). |
...
| :---: | :--- |
| [![Road Roaster 4W](projects/road-roaster/road-roaster-4w/road-roaster-4w.png)](projects/road-roaster/road-roaster-4w/) | ### 1. [Road Roaster 4W](projects/road-roaster/road-roaster-4w/README.md)<br>**4-Wheel Commercial Platform Dolly Infrared Thermal Weed Shock Sled**<br><br>• **Application**: Commercial driveway, roadway, and agricultural headland chemical-free weed eradication.<br>• **Core Engine**: 30,000 BTU Solaronics K-30 ceramic infrared radiant engine ($1,800^\circ\text{F}$ downward emitter) with flared reflector hood.<br>• **Chassis & Running Gear**: Heavy-duty 24" × 36" diamond-plate steel platform cart; dual front rigid casters, dual rear 360° swivel casters with brakes; 29" push handle.<br>• **Key Innovations**: 3-sided wrap-around rigid front skirt with continuous 3/4" pivot axle; 180° flip-back cantilever stowage; full 20 lb propane cylinder (~14.4 hrs runtime); 2.5 gal pressurized water safety washdown reservoir; auxiliary spot-weed torch wand holstered on handle; slow-crawl propulsion ready.<br>• **Active Master**: [**v0.2.0**](projects/road-roaster/road-roaster-4w/) 🟢 **`[RELEASED]`**<br>• 📖 [**`README.md`**](projects/road-roaster/road-roaster-4w/README.md) \| 📐 [**`SPECIFICATION.md`**](projects/road-roaster/road-roaster-4w/SPECIFICATION.md) \| 📋 [**`BOM.md`**](projects/road-roaster/road-roaster-4w/BOM.md) \| 📜 [**`CHANGELOG.md`**](projects/road-roaster/road-roaster-4w/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](projects/road-roaster/road-roaster-4w/build.py) \| 📦 [**`road-roaster-4w.FCStd`**](projects/road-roaster/road-roaster-4w/road-roaster-4w.FCStd) |
| [![Road Roaster 2W](projects/road-roaster/road-roaster-2w/road-roaster.png)](projects/road-roaster/road-roaster-2w/) | ### 2. [Road Roaster 2W](projects/road-roaster/road-roaster-2w/README.md)<br>**Directional Ceramic Infrared Weed Shock Sled (2-Wheel Hand Truck Variant)**<br><br>• **Application**: Chemical-free hardscape weed eradication on residential paths, gravel borders, and tight garden beds.<br>• **Core Engine**: 60,000 BTU downward-firing Solaronics ceramic infrared radiant burner; zero aerodynamic blast pressure; 15–30s deep thermal shock.<br>• **Chassis**: Vintage restored 1.0" OD tubular steel hand truck frame with triangular axle trusses and 9.5" wheels.<br>• **Key Innovations**: Common-wheel-axle suspension sled; 1 lb onboard propane cylinder in quick-release cage; dual-mode gliding roast vs. tilt-back transit.<br>• **Active Master**: [**v0.7.0**](projects/road-roaster/road-roaster-2w/) 🟡 **`[IN PROGRESS]`**<br>• 📖 [**`README.md`**](projects/road-roaster/road-roaster-2w/README.md) \| 📐 [**`SPECIFICATION.md`**](projects/road-roaster/road-roaster-2w/SPECIFICATION.md) \| 📜 [**`CHANGELOG.md`**](projects/road-roaster/road-roaster-2w/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](projects/road-roaster/road-roaster-2w/build.py) \| 📦 [**`road-roaster.FCStd`**](projects/road-roaster/road-roaster-2w/road-roaster.FCStd) |
...
| [![Compact Foam Camper](projects/foam-camper/foam-camper.png)](projects/foam-camper/) | ### 4. [Compact Foam Camper](projects/foam-camper/README.md)<br>**Ultralight 12' x 6.5' Pop-Top Rigid Foam Camper & Multi-Buck Fabrication Suite**<br><br>• **Application**: Ultralight towable micro-camper shell engineered for single-axis 1D scored and curved Extruded Polystyrene (XPS) rigid foam.<br>• **Core Architecture**: Parametric FreeCAD 1.1 `App::VarSet` engine (`Vars`) sized for a 12'-0" × 6'-6" trailer bed; orthogonal intersection of two single-axis developable curved planes ($XY$ boat-tail plan curve and $XZ$ aerodynamic elevation curve) forming a compound 3D shoulder seam without compound panel bending; modular partition into Left/Port and Right/Starboard side frames, central 20" ($508\text{ mm}$) pop-up roof frame with weather-resistant canvas bellows, front towing-end bulkhead with 24" center walk-through door, and rear transom; 6'0" standing mannequin reference ($\ge 6'5.5''$ / $1,968\text{ mm}$ standing headroom in camping mode); reference trailer chassis with tongue A-frame walk platform.<br>• **Fabrication Suite**: Master Egg-Crate Assembly Buck (`camper_assembly_buck.FCStd`, 134.3 lbs) on trailer deck with walk-through door extraction; Pop-Up Roof Canopy Form Buck (`roof_canopy_buck.FCStd`, 187.3 lbs); Side Wall Bending Jig (`side_wall_buck.FCStd`, 46.6 lbs).<br>• **Active Master**: [**v0.3.0**](projects/foam-camper/) 🟢 **`[CURRENT / ACTIVE]`**<br>• 📖 [**`README.md`**](projects/foam-camper/README.md) \| 📋 [**`ASSEMBLY.md`**](projects/foam-camper/ASSEMBLY.md) \| 🔨 [**`fabrication/`**](projects/foam-camper/fabrication/README.md) \| 📐 [**`SPECIFICATION.md`**](projects/foam-camper/SPECIFICATION.md) \| 📜 [**`CHANGELOG.md`**](projects/foam-camper/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](projects/foam-camper/build.py) \| 🔨 [**`build_bucks.py`**](projects/foam-camper/fabrication/build_bucks.py) \| 📦 [**`foam-camper.FCStd`**](projects/foam-camper/foam-camper.FCStd) |
...
flowchart TD
    ...
    subgraph L3["Level 3: Master Integrated Assemblies"]
        M1["Road Roaster 4W (road-roaster/road-roaster-4w)"]
        M2["Road Roaster 2W (road-roaster/road-roaster-2w)"]
        M3["Kombi Kaddy (kombi-kaddy)"]
        M4["Compact Foam Camper (foam-camper)"]
    end
...
| :---: | :---: | :--- |
| [![v0.2.0](projects/road-roaster/road-roaster-4w/changelog/v0.2.0.png)](projects/road-roaster/road-roaster-4w/) | **v0.2.0**<br>`2026-09-08`<br>🟢 `[RELEASED]` | Solaronics K-30 ceramic infrared engine integration; 3-sided wrap-around pivot skirt with continuous 3/4" axle; 180° flip-back stowage; 20 lb LP gas manifold and auxiliary spot-weed torch holster. |
| [![v0.1.0](projects/road-roaster/road-roaster-4w/changelog/v0.1.0.png)](projects/road-roaster/road-roaster-4w/) | **v0.1.0**<br>`2026-09-07`<br>📦 `[SUPERSEDED]` | Initial 4-wheel platform cart foundation; 24x36 diamond plate deck, running gear subassembly, and baseline hood geometry. |
...
| **Build Project (Road Roaster 4W)** | `./scripts/run_freecad.sh projects/road-roaster/road-roaster-4w/build.py` |
| **Build Project (Road Roaster 2W)** | `./scripts/run_freecad.sh projects/road-roaster/road-roaster-2w/build.py` |
| **Build Project (Kombi Kaddy)** | `./scripts/run_freecad.sh projects/kombi-kaddy/build.py` |
| **Build Project (Compact Foam Camper)** | `./scripts/run_freecad.sh projects/foam-camper/build.py` |
