...
- [x] **Road Roaster 4W (v0.1.0 Master)**: Heavy-duty 4-wheel commercial platform cart foundation with 5" running gear, 29" handle, 20 lb propane capacity, and 180° flip cantilevered burner architecture (`projects/road-roaster-4w/`).
