...
- [x] **20 lb Propane Cylinder**: Standard vertical LP tank model with foot ring and collar handle (`components/propane_cylinder_20lb/`).
- [x] **Front Cantilever 180° Flip Hinge Bracket & Skirt Assembly**: Front-mounted dual-arm pivot bracket with continuous 3/4" axle and 3-sided wrap-around rigid skirt (`projects/road-roaster/road-roaster-4w/subassemblies/cantilever_burner/`).
...
- [x] **Road Roaster Suite**: Directional flameless ceramic infrared thermal weed eradication platform (`projects/road-roaster/`).
  - [x] **Road Roaster 2W (v0.7.0 Master)**: Ultra-compact directional ceramic infrared weed shock sled with common-wheel-axis triangular suspension on restored vintage hand truck chassis (`projects/road-roaster/road-roaster-2w/`).
  - [x] **Road Roaster 4W (v0.2.0 Master)**: Heavy-duty 4-wheel commercial platform cart foundation with Solaronics K-30 infrared burner, continuous 3/4" pivot axle, 3-sided wrap-around rigid skirt, 20 lb propane capacity, and 180° flip cantilever stowage (`projects/road-roaster/road-roaster-4w/`).
