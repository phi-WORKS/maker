...
- [x] **Front Cantilever 180° Flip Hinge Bracket & Skirt Assembly**: Front-mounted dual-arm pivot bracket with continuous 3/4" axle and 3-sided wrap-around rigid skirt (`projects/road-roaster-4w/subassemblies/cantilever_burner/`).
...
- [x] **Road Roaster 4W (v0.2.0 Master)**: Heavy-duty 4-wheel commercial platform cart foundation with Solaronics K-30 infrared burner, continuous 3/4" pivot axle, 3-sided wrap-around rigid skirt, 20 lb propane capacity, and 180° flip cantilever stowage (`projects/road-roaster-4w/`).
