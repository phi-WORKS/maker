"""
5.0" Commercial Caster Wheel Standalone Build Script

Builds caster_wheel_5in.FCStd, prints mass properties, and exports 7 standard orthogonal and isometric PNG renders.
"""
...
from caster_wheel_5in import create_caster_wheel_5in_component
...
def build():
    ...
    print("5.0\" Caster Wheel build complete.")
