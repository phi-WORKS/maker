...
PYTHONPATH=src xvfb-run -a /home/phi/AppImages/FreeCAD_1.1.3-Linux-x86_64-py311.AppImage -c "__file__='components/solaronics_infrared_burner/build.py'; exec(open(__file__).read())"
```
