"""
STIHL KMA 200 R Cordless KombiEngine Power Head Standalone Build Script

Builds stihl_kma200r.FCStd, prints mass properties, and exports 7 standard orthogonal and isometric PNG renders.
"""
...
from stihl_kma200r import create_stihl_kma200r_component
...
def build():
    doc_name = "stihl_kma200r"
    doc = FreeCAD.newDocument(doc_name)

    grp = create_stihl_kma200r_component(doc)
    doc.recompute()

    report = get_mass_properties(grp)
    print(format_mass_report(report, title="STIHL KMA 200 R KombiEngine Mass Report"))
    ...
    print("STIHL KMA 200 R build complete.")
