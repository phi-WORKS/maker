"""
STIHL FBD-KM Bed Redefiner Attachment Standalone Build Script

Builds kombi_bed_redefiner_fbd.FCStd, prints mass properties, and exports 7 standard orthogonal and isometric PNG renders.
"""
...
from kombi_bed_redefiner_fbd import create_kombi_bed_redefiner_fbd_component
...
def build():
    doc_name = "kombi_bed_redefiner_fbd"
    doc = FreeCAD.newDocument(doc_name)

    grp = create_kombi_bed_redefiner_fbd_component(doc)
    doc.recompute()

    report = get_mass_properties(grp)
    print(format_mass_report(report, title="STIHL FBD-KM Bed Redefiner Mass Report"))
    ...
    print("STIHL FBD-KM Bed Redefiner build complete.")
