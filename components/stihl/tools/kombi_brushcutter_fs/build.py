"""
STIHL FS-KM Brush Cutter Component Standalone Build Script

Builds kombi_brushcutter_fs.FCStd, prints mass properties, and exports 7 standard orthogonal and isometric PNG renders.
"""
...
from kombi_brushcutter_fs import create_kombi_brushcutter_fs_component
...
def build():
    doc_name = "kombi_brushcutter_fs"
    doc = FreeCAD.newDocument(doc_name)

    grp = create_kombi_brushcutter_fs_component(doc)
    doc.recompute()

    report = get_mass_properties(grp)
    print(format_mass_report(report, title="STIHL FS-KM Brush Cutter Mass Report"))
    ...
    print("STIHL FS-KM Brush Cutter build complete.")
