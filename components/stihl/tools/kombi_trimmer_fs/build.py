"""
STIHL FS-KM Straight Shaft String Trimmer Component Standalone Build Script

Builds kombi_trimmer_fs.FCStd, prints mass properties, and exports 7 standard orthogonal and isometric PNG renders.
"""
...
from kombi_trimmer_fs import create_kombi_trimmer_fs_component
...
def build():
    doc_name = "kombi_trimmer_fs"
    doc = FreeCAD.newDocument(doc_name)

    grp = create_kombi_trimmer_fs_component(doc)
    doc.recompute()

    report = get_mass_properties(grp)
    print(format_mass_report(report, title="STIHL FS-KM String Trimmer Mass Report"))
    ...
    print("STIHL FS-KM String Trimmer build complete.")
