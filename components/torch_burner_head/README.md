...
![500,000 BTU Torch Burner Head](torch_burner_head.png)
...
| :---: | :---: |
| ![Home View](torch_burner_head.png) | ![Top View](torch_burner_head_top.png) |
| **Front Elevation** | **Rear Elevation** |
| ![Front Elevation](torch_burner_head_front.png) | ![Rear Elevation](torch_burner_head_back.png) |
| **Right Side Elevation** | **Left Side Elevation** |
| ![Right Side View](torch_burner_head_right.png) | ![Left Side View](torch_burner_head_left.png) |
| **Bottom Plan View** | |
| ![Bottom View](torch_burner_head_bottom.png) | |
...
./scripts/run_freecad.sh components/torch_burner_head/build.py

# Or directly with xvfb-run:
PYTHONPATH=src xvfb-run -a /home/phi/AppImages/FreeCAD_1.1.3-Linux-x86_64-py311.AppImage -c "__file__='components/torch_burner_head/build.py'; exec(open(__file__).read())"
```
