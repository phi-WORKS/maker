...
| ![Right Side View](torch_control_handle_right.png) | ![Left Side View](torch_control_handle_left.png) |
| **Bottom Plan View** | |
| ![Bottom View](torch_control_handle_bottom.png) | |
...
./scripts/run_freecad.sh components/torch_control_handle/build.py

# Or directly with xvfb-run:
PYTHONPATH=src xvfb-run -a /home/phi/AppImages/FreeCAD_1.1.3-Linux-x86_64-py311.AppImage -c "__file__='components/torch_control_handle/build.py'; exec(open(__file__).read())"
```
