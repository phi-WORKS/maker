...
| Master Assembly Thumbnail | Quick Specifications & Links |
| :---: | :--- |
| [![Compact Foam Camper](foam-camper/foam-camper.png)](foam-camper/) | • **Application**: Ultralight micro-camper shell featuring 1D transverse developable curvature, organic tumblehome curved sides, and an independent pop-up roof canopy.<br>• **Core Architecture**: Parametric FreeCAD 1.1 `App::VarSet` engine (`Vars`); 3 independent modular subassemblies (Port & Starboard curved side frames, Center pop-up arched roof frame); towing-end $24''$ center walk-through entrance doorway opening onto the trailer tongue platform; parametric vertical lift ($0\ \text{mm}$ travel to $508\ \text{mm}$ / $20''$ camping stroke); verified **$6'4''$ ($1,930\ \text{mm}$) interior standing headroom** with scale 6'0" mannequin; low-profile travel mode fits under standard 7-foot garage doors.<br>• **Active Master**: [**v0.2.0**](foam-camper/) 🟢 **`[CURRENT / ACTIVE]`**<br>• 📖 [**`README.md`**](foam-camper/README.md)<br>• 📋 [**`ASSEMBLY.md`**](foam-camper/ASSEMBLY.md)<br>• 🔨 [**`fabrication/`**](foam-camper/fabrication/README.md)<br>• 📐 [**`SPECIFICATION.md`**](foam-camper/SPECIFICATION.md)<br>• 📜 [**`CHANGELOG.md`**](foam-camper/CHANGELOG.md)<br>• 🛠️ [**`build.py`**](foam-camper/build.py)<br>• 📦 [**`foam-camper.FCStd`**](foam-camper/foam-camper.FCStd) |
