# Compact Foam Camper - Fabrication Assembly Protocol
...
**Master Assembly Guide**: [`../ASSEMBLY.md`](../ASSEMBLY.md)  
**Fabrication Buck Model**: [`camper_buck.FCStd`](camper_buck.FCStd)  
**Flat Patterns & Kerf Schedule Model**: [`flat_patterns.FCStd`](flat_patterns.FCStd)  

---

## Executive Overview

This protocol details the hands-on shop fabrication steps for constructing the $12' \times 6.5'$ rigid XPS foam camper shell using the interlocking egg-crate buck and dynamic kerf scoring.

![Master Assembly Concept](camper_buck_with_shell.png)
*Fig 1: The finished assembly concept: $2.0''$ scored rigid foam shell bent over the internal 3/4" interlocking plywood buck.*
...
### Sheet Goods & Lumber:
- **XPS Rigid Insulation Foam**: $6\times$ sheets of $2.0'' \times 4' \times 8'$ Extruded Polystyrene (Owens Corning Foamular 150/250 or Dow Styrofoam).
- **Plywood for Buck**:
...
- **Floor Deck**: $2\times$ sheets of $3/4''$ Marine/Exterior Plywood (trailer floor subdeck).
...
3. **Snap Centerline & Station Layout Lines**:
   ...
   - Mark the 5 transverse station lines across the deck:
     - **Station 0**: $X = 60\ \text{mm}$ ($2.4''$) from front edge (Nose).
...
![Egg-Crate Plywood Buck](camper_buck.png)
*Fig 2: 3D view of the 5 transverse bulkheads mated to the 3 longitudinal stringers via half-lap slots.*

### Assembly Sequence:
1. **Cut the Buck Components**:
   - Cut the 5 transverse bulkheads and 3 longitudinal stringers following [`build_buck.py`](build_buck.py).
   - Ensure all half-lap slots are cut to $19.5\ \text{mm}$ ($0.77''$) width.
...
4. **Lock In Left & Right Shoulder Stringers**:
   ...
   - The grid will self-square and become completely rigid.
5. **Toe-Pin to Deck**:
...
![Buck Top and Profile Views](camper_buck_top.png)
*Fig 3: Top plan view showing interlocking half-lap slot grid and stringer spacing.*

---

## Stage 3: Preparing Flat Foam Sheets & Kerf Scoring

The total unrolled length of the roof from front prow to rear transom is **$14.74\ \text{ft}$ ($4,492.6\ \text{mm}$)**.

![Unrolled Scored Roof Blank](flat_scored_sheet.png)
*Fig 4: Unrolled 14.74 ft roof blank showing dynamic kerf score cuts and standard 4x8 ft sheet outlines.*
...
3. **Install Ratchet Straps**:
   ...
   - Ratchet down slowly. Observe the kerf slits: they will smoothly **pinch closed** as the sheet conforms to the curved stringers!
4. **Check Seams**:
