...
| :---: | :---: | :--- | :---: |
| **[v1.9.0](v10/)**<br>*(v10 Master)* | ![v10 Snapshot](v10/caddy_v10.png) | **Master Cantilever Expansion**: Expanded top/bottom rails to 36.0" width with 6.0" cantilever overhangs, allowing 4 full-sized attachments to be mounted without clip crowding while preserving 24.0" post alignment for garage studs.<br><br>📋 [**REQUIREMENTS.md**](v10/REQUIREMENTS.md) • 📐 [**SPECIFICATION.md**](v10/SPECIFICATION.md) • ✂️ [**CUT_LIST.md**](v10/CUT_LIST.md) • 🛠️ [**build.py**](v10/build.py) | 🟢 **`[BUILT & VERIFIED]`** |
