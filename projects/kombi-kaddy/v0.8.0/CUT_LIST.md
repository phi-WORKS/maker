# Woodworking Cut List & Bill of Materials (BOM) - Kombi Caddy (Version 9 Master)
...
| **Upper Top Rail** | 1 | 0.75" (19 mm) | 3.5" (89 mm) | 36.0" (914 mm) | 1x4 Lumber | Housed flush into 0.75" top front post pockets (center Z = 42.75" above floor) |
...
| **Spring Tool Holder Clips** | Rubber Roller Wall-Mount Clips | 4 | Mounted on top front rail (centered @ Z = 42.75", grabbing shaft 1" below tip) |
...
- `ToolStandingHeight`: `1003.3 mm` (39.5 in standing tool height from deck)
- `ClipGrabOffsetFromTop`: `25.4 mm` (1.0 in clip grab distance below shaft tip)
