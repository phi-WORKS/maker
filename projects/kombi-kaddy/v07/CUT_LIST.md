# Woodworking Cut List & Bill of Materials (BOM) - Kombi Caddy (Version 7 Master)
...
- **1x4 Dimensional Construction Lumber**: **1 board @ 8 Feet (96 inches)**
  - *Actual Cross-Section*: 0.75" x 3.5" (19.05 mm x 88.9 mm)
  - *Used For*: 1x Upper Top Rail (36") + 1x Lower Rear Cross Rail (36")
...
- `RailThickness`: `19.05 mm` (0.75 in — 1x4 cross rails)
