...
> **Directional Ceramic Infrared Thermal Weed Shock Sled (Small / Compact Hand Truck Model)**  
...
**Parallel Variant**: [**Road Roaster 4W (Commercial Platform Cart Model)**](../road-roaster-4w/README.md)  

![Road Roaster 2W](road-roaster.png)
...
| :---: | :---: |
| ![Home View](road-roaster.png) | ![Top View](road-roaster_top.png) |
...
| **v0.3.0** | 📦 `[SUPERSEDED]` | Modular Subassembly Containers & Parametric VarSet | ![v0.3.0](changelog/v0.3.0_iso.png) |
| **v0.2.0** | 📦 `[SUPERSEDED]` | Ergonomic Forward Lean Torch Integration | ![v0.2.0](changelog/v0.2.0_iso.png) |
| **v0.1.0** | 📦 `[SUPERSEDED]` | Mechanical Sled Integration & Tow Bar | ![v0.1.0](changelog/v0.1.0_iso.png) |
| **v0.0.0** | 📦 `[SUPERSEDED]` | Baseline Sled Skid & Pyramid Hood Prototype | ![v0.0.0](changelog/v0.0.0_iso.png) |
