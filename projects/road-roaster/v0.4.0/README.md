...
## 1. Version 0.4.0 Overview

Version 0.4.0 introduces onboard fuel bottle mounting, quick-release harness integration, and build script function-level refactoring:
...
- **Functional Build Script Architecture**: Decomposes `v0.4.0/build.py` into modular subassembly builder functions (`build_hood_subassembly`, `build_overhead_frame_subassembly`, `build_torch_subassembly`, `build_propane_harness_subassembly`, `build_tow_rigging_subassembly`).

**CAD Model**: [`sled_v0.4.0.FCStd`](sled_v0.4.0.FCStd)

| ![Isometric View](sled_v0.4.0_iso.png) | ![Top View](sled_v0.4.0_top.png) |
| :---: | :---: |
| ![Front Elevation](sled_v0.4.0_front.png) | ![Rear Elevation](sled_v0.4.0_back.png) |
| ![Right Side View](sled_v0.4.0_right.png) | ![Left Side View](sled_v0.4.0_left.png) |
| ![Bottom View](sled_v0.4.0_bottom.png) | |

---

## 2. Documentation Index

- 📋 [**REQUIREMENTS.md**](REQUIREMENTS.md) — Requirement delta matrix from v0.3.0 master baseline.
...
To generate the active master model (Version 0.4.0) and export all 7 orthographic/isometric PNG snapshot renders:
