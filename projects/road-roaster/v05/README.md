# Road Roaster — Version 1.4.0 (v05)
...
## 1. Version 05 Overview

Version 1.4.0 (v05) introduces onboard fuel bottle mounting, quick-release harness integration, and build script function-level refactoring:
...
- **Functional Build Script Architecture**: Decomposes `v05/build.py` into modular subassembly builder functions (`build_hood_subassembly`, `build_overhead_frame_subassembly`, `build_torch_subassembly`, `build_propane_harness_subassembly`, `build_tow_rigging_subassembly`).

---

## 2. Documentation Index

- 📋 [**REQUIREMENTS.md**](REQUIREMENTS.md) — Requirement delta matrix from v04 master baseline.
...
To generate the active master model (Version 05) and export all 7 orthographic/isometric PNG snapshot renders:
